...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData () {
        ...
        $this->SetX($left += 25); $this->Cell(35, $h, 'ID', 1, 0, 'C',true);
        $this->SetX($left += 35); $this->Cell(75, $h, 'Pelanggan', 1, 0, 'C',true);
        $this->SetX($left += 75); $this->Cell(85, $h, 'Keluhan', 1, 0, 'C',true);
        $this->SetX($left += 85); $this->Cell(85, $h, 'Penyebab', 1, 0, 'C',true);
        $this->SetX($left += 85); $this->Cell(85, $h, 'Tindakan', 1, 0, 'C',true);
        $this->SetX($left += 85); $this->Cell(65, $h, 'Tanggal', 1, 0, 'C',true);
        $this->SetX($left += 65); $this->Cell(75, $h, 'Teknisi', 1, 1, 'C',true);
        //$this->Ln(20);

        #data dari database
        $this->SetFont('Arial','',10);
        $this->SetWidths(array(25,35,75,85,85,85,65,75));
        ...
        $this->Ln(40);
        $this->SetX(400); $this->Cell(0, 20, 'Edi Waryono, S.Kom, M.Kom', 0, 1,'C');
    }
